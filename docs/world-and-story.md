...
**Who they are:** Underground network refusing to be corrected. They preserve forbidden language, restore words, free thoughts. Cell-based ("pockets") — Archivists, Teachers, Couriers, Infiltrators (Ministry insiders), Speakers. Use real names (act of trust). Teach Black Words — **current canon (2026-05-25): witness, relative, individual, independent, private** (TOEIC-adjacent B1; superseded the earlier mother/father/freedom/truth/name list when the Lexicon shipped).
...
| Approved vocabulary only | Black Words — witness, relative, individual, independent, private |
...
**Full design spec for W4 first contact:** `Dplan/Weeks_04_06_Shift_Plan.md` § Week 4 (Activity Reconciliation) + § Week 4 Clips § Clip A. Content committed `77e5937` (2026-05-11). **All frontend pieces SHIPPED 2026-05-25/26** (queue sidebar, Obs-E mutation, `[ ].edited` draggable window + funnel pill — NOT a desktop tile — Drop Box, recruitment modal); Cipher rebuilt 2026-06-03 as the 3-doc redacted-reveal. **Only the Canva Clip A/B videos remain.**
...
- Week 4 WeekConfig shipped 2026-04-21; content redesigned 2026-05-11 (`77e5937`) — frame swapped from "Evidence Board" to "Activity Reconciliation," Unedited contact folded into Clip A, `[ ].edited` hidden app introduced. W4 dictionary rows now ship via the `ensureDictionaryWordsForAllWeeks` startup migration (2026-06-09); W4 Harmony has full static censure content but bulletins/tips/notices/sector-reports/verdict posts remain W1-3-only (deferred). All frontend components for the new design shipped 2026-05-25/26.
