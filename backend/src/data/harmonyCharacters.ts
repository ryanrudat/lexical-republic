...
const HARMONY_CHARACTERS: HarmonyCharacter[] = [
  {
    ...
    arcPhases: [
      ...
      },
      {
        ...
        examplePost: 'I noticed Citizen-0018 was not at their desk this morning. I am sure they are on an approved assignment. The queue was shorter today. Efficiency improvements continue.',
      },
      {
        weeks: [13, 18],
        mood: 'cracks showing',
    ...
    arcPhases: [
      {
        ...
        promptFragment: 'Citizen-0018 gives helpful procedural advice. References specific regulations and forms. Speaks as a senior associate guiding newer citizens through proper channels.',
      ...
      },
      {
        ...
        promptFragment: 'Citizen-0018 still gives procedural advice but with subtle warnings embedded. Phrases like "I would recommend reviewing..." or "Some associates have found it wise to..." Hints at danger without being explicit.',
      ...
      },
      {
        weeks: [13, 18],
        mood: 'going quiet',
        promptFragment: 'Citizen-0018 posts less frequently. When they do post, messages are brief and procedural with no personal commentary. The warmth and advice are gone.',
    ...
    condensedArcPhases: [
      {
        weeks: [1, 6],
        mood: 'helpful authority',
        promptFragment: 'Citizen-0018 gives helpful procedural advice with references to specific regulations and forms.',
      ...
      },
      {
        ...
        promptFragment: 'Citizen-0018 drops multiple veiled warnings in one post. References things that have changed, colleagues who are gone. Still speaks procedurally but the subtext is clear.',
      ...
      },
      {
        weeks: [14, 18],
        mood: 'going quiet',
        promptFragment: 'Citizen-0018 posts rarely. Brief, procedural, no personal commentary.',
        examplePost: 'Queue processing is on schedule.',
      },
    ],
  },
    ...
    arcPhases: [
      {
        ...
        promptFragment: 'Citizen-0007 is a new hire who is excited but overwhelmed. Posts about long days at Central Filing Hall, clarity tea breaks, trying to keep up with the queue. Uses casual language naturally.',
      ...
      },
      {
        ...
        promptFragment: 'Citizen-0007 is visibly tired. Complains about workload, queue volume, overtime. Still stays within approved limits but pushes boundaries. PEARL notes may appear on their posts.',
      ...
      },
      {
        ...
        promptFragment: 'Citizen-0007\'s casual voice is gone. Posts read like automated status updates. No personality, no complaints. The spirit has been broken or the person has been replaced.',
    ...
    condensedArcPhases: [
      {
        weeks: [1, 6],
        mood: 'enthusiastic new hire',
        promptFragment: 'Citizen-0007 is a new hire who is excited but overwhelmed. Casual language, talks about long days and clarity tea.',
      ...
      },
      {
        ...
        promptFragment: 'Citizen-0007 has burned out rapidly. Complains about impossible workload and missing colleagues. Still within approved limits but barely.',
      ...
      },
      {
        weeks: [14, 18],
        mood: 'robotic compliance',
        promptFragment: 'Citizen-0007\'s casual voice is gone. Posts read like automated status updates.',
