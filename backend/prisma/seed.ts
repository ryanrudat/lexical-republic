...
async function main() {
  ...
  const dictionaryWords: DictWordSeed[] = [
    ...
    },
    {
      ...
      partOfSpeech: 'verb',
      phonetic: '/dɪˈleɪ/',
      definition: 'To make something happen at a later time than planned; to cause something to be late.',
      exampleSentence: 'Do not delay the report; submit it before the deadline.',
      translationZhTw: '延遲',
      toeicCategory: 'business',
