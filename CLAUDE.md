...
- Hybrid class model app changes — compact intake_form mode, `teacherLed` task gating flag (task gate system now implemented), teacher "advance to Station Work" signal in dashboard.
